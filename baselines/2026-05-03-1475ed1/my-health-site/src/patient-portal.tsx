...
function HealthSummaryCard({ item }: { item: typeof healthSummaryItems[0] }) {
  return (
    <CardLayout
      shape="SEMI_ROUNDED"
      borderColor="#DCE6E8"
...
function HealthSummaryContent() {
  // Split into two columns matching the screenshot layout
  const left = healthSummaryItems.filter((_, i) => i % 2 === 0)
  const right = healthSummaryItems.filter((_, i) => i % 2 === 1)
